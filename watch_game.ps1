param(
    [string]$WindowTitle = "The Inferno's Curse",
    [string]$OutputDir = 'C:\TheInfernoCurse\screenshots',
    [int]$Count = 10,
    [int]$DelayMs = 100
)
...
Write-Host "Capturing $Count screenshots from window '$WindowTitle' to '$OutputDir'..."
