...
_mk_exit(room_width - 72, room_height * 0.5 - 96, 72, 192, "Room_florence", "To Florence");
// South — central steps -> Ponte Vecchio — REMOVED 2026-06-10 (room deleted
// for the accurate EW rebuild; restore this exit when the new room exists):
