...
trigger_dir = "any";    // Direction player must move to trigger: "south", "north", "east", "west", or "any"
...
// --- Enclosed Gatehouse Transition State ---
transition_triggered = false; // Locks state when the south fade sequence begins
fade_alpha  = 0;              // 0 to 1 for fade-to-black atmospheric transition
fade_speed  = 0.02;           // Duration of the fade

// visible must be true for Draw GUI (fade overlay) to run
visible     = true;
