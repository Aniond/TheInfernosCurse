...
function scr_npc_default_data() {
    return {
        npcs: {
            ...
            stableboy: { tier: 2, name: "Nico",           role: "stableboy", handles: ["horses", "lodging", "rumors"],        location: "fiorentine_stable",  relationship_score: 0, emotion_state: "neutral", sin_awareness: 0, event_log: [] },
        }
    };
}
